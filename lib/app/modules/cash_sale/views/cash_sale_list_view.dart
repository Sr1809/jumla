...
import 'package:jumla/app/modules/cash_sale/views/cash_sale_detail_view.dart';
import 'package:jumla/app/modules/sales_order/views/sales_order_detail_view.dart';
import 'package:jumla/app/modules/sales_order/views/sales_order_view.dart';

import '../../../core/app_storage.dart';
import '../../../resources/app_colors.dart';
import '../../../resources/app_styles.dart';
import '../../../routes/app_pages.dart';
import '../../customers_list/views/customer_detail_view.dart';
import '../../estimate/views/estimate_detail_view.dart';
import '../../invoice/views/invoice_detail_view.dart';
import '../../reports/views/filter_view.dart';
import '../controllers/cash_sale_controller.dart';

class CashOrderListView extends StatelessWidget {
  CashOrderListView({super.key});


  @override
  Widget build(BuildContext context) {
    var controller = Get.put(CashSaleController());
    return Scaffold(
              ...
              child: Row(
                children: [
                  ...
                  if (controller.isSearching.value)
                    ...
                    Expanded(
                      child: Text("Cash Sales", style: AppTextStyles.bold(fontColor: Colors.white, fontSize: 20.0)),
                    ),
                  if (controller.isSearching.value)
                    IconButton(
                            ...
                            child: Column(
                              ...
                              children: [
                                ListTile(
                                  ...
                                  title: Text("View this cash sale"),
                                  onTap: () {
                                    Get.back();
                                    Get.to(() => CashSaleDetailView());
                                  },
                                ),
                                ListTile(
                                ...
                                ListTile(
                                  ...
                                  title: Text("Delete this cash sale"),
                                  onTap: () {
