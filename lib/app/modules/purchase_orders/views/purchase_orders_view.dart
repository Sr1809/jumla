...
import 'package:jumla/app/modules/cash_sale/views/cash_sale_view.dart';
              ...
              child: Row(
                children: [
                  ...
                  if (controller.isSearching.value)
                    ...
                    Expanded(
                      child: Text("Purchase Orders", style: AppTextStyles.bold(fontColor: Colors.white, fontSize: 20.0)),
                    ),
                  if (controller.isSearching.value)
                    IconButton(
                            ...
                            child: Column(
                              ...
                              children: [
                                ListTile(
                                  ...
                                  title: Text("View this purchase order"),
                                  onTap: () {
                                    Get.back();
                                    Get.to(()=>InvoiceDetailView(title: "PURCHASEORDER",));
                                  },
                                ),
                                ListTile(
                                ...
                                ListTile(
                                  ...
                                  title: Text("Delete this purchase order"),
                                  onTap: () {
