...
class AddCurrencyDateFormatsView
    ...
    return Scaffold(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDateFormatRow("Long date:", DateFormat('MMMM d, y').format(DateTime.now()), textSize),
                _buildDateFormatRow("Medium date:", DateFormat('MMM d, y').format(DateTime.now()), textSize),
                _buildDateFormatRow("Short date:", DateFormat('M/d/yy').format(DateTime.now()), textSize),
               ...
               // _buildInputLabel("Currency format", textSize),
                _buildTextField(controller.currencyFormatController, "1,234.56", 120, textSize),
             ...
             //   _buildInputLabel("Currency symbol", textSize),
                _buildTextField(controller.currencySymbolController, "  ", 60, textSize),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            _buildNavButton("NEXT", Routes.ADD_TAX_SETUP, textSize),
            SizedBox(width: 10),
  ...
  Widget _buildSectionTitle(String title, double textSize) {
    return Text(
      title,
      style: AppTextStyles.regular(fontSize: textSize, fontColor: AppStorages.appColor.value),
    );
  }
  ...
  Widget _buildDateFormatRow(String label, String value, double textSize) {
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(width: 120, child: Text(label, style: AppTextStyles.regular(fontSize: textSize * 0.7, fontColor: AppColors.greyColor))),
          Text(value, style: AppTextStyles.medium(fontSize: textSize * 0.8, fontColor: AppColors.greyColor)),
        ],
      ),
    );
  }
  ...
  Widget _buildDateFormatPicker(BuildContext context, double textSize) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text("Use this format:", style: AppTextStyles.semiBold(fontSize: textSize * 0.7, fontColor: AppColors.blackColor)),
          GestureDetector(
            onTap: () {
            ...
            child: Obx(() => _buildPickerBox(controller.dateFormatController.value)),
          ),
        ],
      ),
    );
  ...
  Widget _buildTextField(TextEditingController controller, String hint, double width, double textSize) {
    return Padding(
  ...
  Widget _buildDescription(String text, double textSize) {
    return Padding(
      ...
      child: Text(
        text,
        style: AppTextStyles.medium(fontSize: textSize * 0.7, fontColor: AppColors.greyColor),
      ),
    );
  }
  ...
  Widget _buildPickerBox(String value) {
    return Container(
      ...
      child: Text(value, style: AppTextStyles.regular(fontSize: 15.0, fontColor: AppColors.whiteColor
      )),
    );
  }
}
