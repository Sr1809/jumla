...
class ItemFieldListView extends StatelessWidget {
  var from;
  ItemFieldListView(this.from);
                  ...
                  return GestureDetector(
                    ...
                    child: Card(
                      ...
                      child: Obx(() => ListTile(
                        ...
                        trailing: from == "item"
                            ? Checkbox(
                          value: selectedItems.contains(field),
                          onChanged: (val) {
                            if (val == true) {
                              selectedItems.add(field);
                            } else {
                            ...
                            : Text(
                          field.isAppliedToCompany.value ? "Item" : "",
            ...
            if (from == "item")
              Container(
                ...
                child: ElevatedButton.icon(
                  style: ElevatedButton.styleFrom(backgroundColor: AppStorages.appColor.value),
                  icon: Icon(Icons.check,color: AppColors.whiteColor,),
                  label: Text("Add Selected",style: AppTextStyles.medium(fontSize: 13.0, fontColor: AppColors.whiteColor),),
                  onPressed: () {
