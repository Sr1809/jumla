...
class CompanyFieldController extends GetxController {
...
class CompanyFieldListView extends StatelessWidget {
  final CompanyFieldController controller = Get.put(CompanyFieldController());
                ...
                return GestureDetector(
                  ...
                  child: Card(
                    ...
                    child: Obx(() => ListTile(
                      ...
                      trailing: Text(
                        field.isAppliedToCompany.value ? "Company" : "",
...
class CompanyFieldFormView extends StatelessWidget {
  final CompanyFieldController controller = Get.find();
