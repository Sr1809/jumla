...
class SalesOrderDetailView extends StatefulWidget {
  const SalesOrderDetailView({super.key});

  @override
  State<SalesOrderDetailView> createState() => _SalesOrderDetailViewState();
}

class _SalesOrderDetailViewState extends State<SalesOrderDetailView> {
