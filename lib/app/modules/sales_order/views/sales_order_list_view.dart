...
class SalesOrderListView extends StatelessWidget {
   SalesOrderListView({super.key});


  @override
  Widget build(BuildContext context) {
    var controller = Get.put(SalesOrderController());
    return Scaffold(
              ...
              child: Row(
                children: [
                  ...
                  if (controller.isSearching.value)
                    ...
                    Expanded(
                      child: Text("Sales Orders", style: AppTextStyles.bold(fontColor: Colors.white, fontSize: 20.0)),
                    ),
                  if (controller.isSearching.value)
                    IconButton(
                            ...
                            child: Column(
                              ...
                              children: [
                                ListTile(
                                  ...
                                  title: Text("View this sales order"),
                                  onTap: () {
                                    Get.back();
                                ...
                                ListTile(
                                  ...
                                  title: Text("Delete this sales order"),
                                  onTap: () {
